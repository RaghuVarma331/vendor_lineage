...
$(call enforce-product-packages-exist-internal,$(wildcard device/*/$(LINEAGE_BUILD)/$(TARGET_PRODUCT).mk),product_manifest.xml Calendar Launcher3 Launcher3Go Launcher3QuickStep Launcher3QuickStepGo)
